...
print()
print("--- At a Glance ---")
print(f"With {MILES_PER_YEAR:,} miles/year and {mean_occupancy_rate:.2%} occupancy,")
print(f"your robotaxi nets ${Actual_Profit:,.2f} annually after costs.")
print()
print("--- Revenue ---")
print(f"Average Annual Revenue per Robotaxi:      ${mean_annual_revenue:,.2f}")
print(f"Average Revenue Per Mile:                      ${mean_revenue_per_mile:,.2f}")
...
print("--- Costs ---")
print(f"Average Annual Cost per Robotaxi:         ${mean_annual_cost:,.2f}")
print(f"Average Annual Cost of Safety Driver:             $0*")
print(f"Average Cost Per Mile:                         ${mean_cost_per_mile:,.2f}**")
print(f"Average Cleaning Cost per Day:                ${mean_cleaning_cost_per_day:,.2f}")
print(f"FSD Subscription Cost per Year:            ${FSD_SUBSCRIPTION:,.2f}")
print()
...
print()
print(f"* Safety Driver Cost is currently set to $0, I believe this would be included in Platform Fee $0.50 p/m")
print(f"** Platform Fee is taken off the top of Revenue Per Mile rather than broken out as part of Cost Per Mile.")
print()
print("==================================================")
